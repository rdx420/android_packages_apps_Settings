/*
 * Copyright (C) 2019-22 The ArrowOS
 *
...
import com.arrow.settings.preferences.SystemSettingMainSwitchPreference;
...
public class NetworkTrafficSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.arrow_settings_network_traffic);
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.arrow_settings_network_traffic);
}
